...
export default function ShutUniHomePage() {
  return (
    <div className="suhome-frame">
      <section className="suhome__hero-fold">
        ...
        <div className="suhome__hero-fold-copy">
          <h1>
            <span className="suhome__hero-fold-line">
              When college marketing spins the truth
            </span>
          ...
          <p>
            Mainstream rankings are rigged, bought, and outdated. So we built a
            place for real, uncensored student feedback to help future students
            see the truth.
          </p>
      ...
      <div className="suhome">
        ...
        <section className="suhome__anon">
          ...
          <p className="suhome__anon-note">
            Post under your real name or complete anonymity. Your honesty protects
            the next applicant, not institutional PR.
          </p>
        </section>

        <section className="suhome__truths">
          <div className="suhome__truths-top">
          ...
          <div className="suhome__truths-bottom">
          ...
          <Image
            ...
            width={441}
            height={743}
            sizes="(max-width: 700px) 90vw, 441px"
          />
        </section>
